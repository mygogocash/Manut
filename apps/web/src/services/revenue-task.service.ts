...
export async function listCrmTasks(
  ...
  return api.get(`/sales-revenue/tasks${buildQuery(params)}`);
}

export async function getCrmTask(
  id: string,
): Promise<ApiSuccessResponse<CrmTask>> {
  return api.get(`/sales-revenue/tasks/${id}`);
}

export async function createCrmTask(
  input: CreateCrmTaskInput,
): Promise<ApiSuccessResponse<CrmTask>> {
  return api.post("/sales-revenue/tasks", input);
}
...
export async function updateCrmTask(
  ...
  return api.put(`/sales-revenue/tasks/${id}`, input);
}

export async function completeCrmTask(
  id: string,
): Promise<ApiSuccessResponse<CrmTask>> {
  return api.put(`/sales-revenue/tasks/${id}/complete`, {});
}

export async function deleteCrmTask(id: string): Promise<void> {
  await api.delete(`/sales-revenue/tasks/${id}`);
}
