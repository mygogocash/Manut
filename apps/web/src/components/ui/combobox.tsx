        ...
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            `
              ...
              ring-foreground/10 pointer-events-auto relative
              max-h-(--available-height) w-(--anchor-width)
              max-w-(--available-width)
              min-w-[calc(var(--anchor-width)+--spacing(7))]
              origin-(--transform-origin) overflow-hidden rounded-lg shadow-md
              ring-1 duration-100
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        `
          border-input flex min-h-8 flex-wrap items-center gap-1 rounded-lg
          border bg-transparent bg-clip-padding px-2.5 py-1 text-sm
          transition-colors
          focus-within:border-ring focus-within:ring-ring/50 focus-within:ring-3
          has-aria-invalid:border-destructive
          has-aria-invalid:ring-destructive/20 has-aria-invalid:ring-3
