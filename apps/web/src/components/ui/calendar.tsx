  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          `
            bg-muted relative isolate z-0 rounded-l-(--cell-radius)
            after:bg-muted after:absolute after:inset-y-0 after:right-0
            after:w-4
          `,
        ...
        range_end: cn(
          `
            bg-muted relative isolate z-0 rounded-r-(--cell-radius)
            after:bg-muted after:absolute after:inset-y-0 after:left-0 after:w-4
          `,
