    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        `
          ...
          rounded-lg border bg-transparent py-2 pr-2 pl-2.5 text-sm
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          `
            bg-popover text-popover-foreground ring-foreground/10 relative z-50
            max-h-(--radix-select-content-available-height)
            max-w-(--radix-select-content-available-width) min-w-36
            origin-(--radix-select-content-transform-origin) overflow-x-hidden
            overflow-y-auto rounded-lg shadow-md ring-1 duration-100
