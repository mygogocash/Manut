  ...
  return (
    ...
    >
      <select
        ...
        data-size={size}
        className={`
          border-input h-8 w-full min-w-0 appearance-none rounded-lg border
      ...
      <ChevronDownIcon
        className={`
          text-muted-foreground pointer-events-none absolute top-1/2 right-2.5
          size-4 -translate-y-1/2 select-none
        `}
        aria-hidden="true"
