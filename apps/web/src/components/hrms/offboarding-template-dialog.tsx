...
export function OffboardingTemplateDialog({ open, onOpenChange }: Props) {
  ...
  async function handleSave() {
    ...
    setSaving(true);
    try {
      await updateOffboardingTemplate({ parts: cleaned });
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle>Manage offboarding template</DialogTitle>
          <DialogDescription>
            Default parts &amp; tasks every new offboarding run starts from.
