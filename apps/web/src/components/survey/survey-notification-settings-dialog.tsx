...
export function SurveyNotificationSettingsDialog({
  open,
  onOpenChange,
}: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose who is emailed when someone submits a response to a survey
            you launched.
          </DialogDescription>
        </DialogHeader>
        ...
        {loading ? (
          ...
          <div className="space-y-2 py-2">
            <Label htmlFor="survey-recipient-input">Recipients</Label>
