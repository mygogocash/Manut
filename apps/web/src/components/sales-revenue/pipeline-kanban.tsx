...
const OpportunityFormDialog = dynamic(() =>
  import("@/components/sales-revenue/opportunity-form-dialog").then(
    (module) => module.OpportunityFormDialog,
  ),
);
const OpportunityDetailSheet = dynamic(() =>
  import("@/components/sales-revenue/opportunity-detail-sheet").then(
    (module) => module.OpportunityDetailSheet,
  ),
);
const LostReasonsManagerDialog = dynamic(() =>
  import("@/components/sales-revenue/lost-reasons-manager-dialog").then(
    (module) => module.LostReasonsManagerDialog,
  ),
);
const StageConfigManagerDialog = dynamic(() =>
  import("@/components/sales-revenue/stage-config-manager-dialog").then(
...
export function PipelineKanban({
  ...
  const canMove = hasPermission("sales-revenue:update");
