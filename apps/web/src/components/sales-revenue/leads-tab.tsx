...
import { ConvertLeadDialog } from "@/components/sales-revenue/convert-lead-dialog";
import { DisqualifyLeadDialog } from "@/components/sales-revenue/disqualify-lead-dialog";
import { LeadDetailSheet } from "@/components/sales-revenue/lead-detail-sheet";
import { LeadFormDialog } from "@/components/sales-revenue/lead-form-dialog";
import { LeadSourcesManagerDialog } from "@/components/sales-revenue/lead-sources-manager-dialog";
...
import { useLeadSources } from "@/hooks/use-revenue-lead-sources";
    ...
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <PermissionButton
            permission="sales-revenue:admin"
            variant="outline"
