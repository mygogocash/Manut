...
const policySchema = z.object({
  ...
  daysPerYear: z.coerce.number<number | string>().int().min(0).max(365),
...
type PolicyFormValues = z.output<typeof policySchema>;
...
export function LeavePolicyDialog({
  ...
  function addApprover() {
    setApprovers((prev) => [
      ...prev,
      { approverType: "manager", approverUserId: null },
    ]);
  }
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground mt-0.5 text-xs">
                    Stages decide requests in order. Empty list falls back to
                    the submitter&apos;s direct manager.
                  </p>
                </div>
                <Button
                  type="button"
