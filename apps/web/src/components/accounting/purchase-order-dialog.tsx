...
export function PurchaseOrderDialog({
  ...
  const orderDateWatch = form.watch("orderDate");
  ...
  useEffect(() => {
    if (open) form.reset(blankDefaults());
  }, [open, form]);
    ...
    >
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Raise a purchase order to a supplier. Receive the goods, then
            convert the received quantities into a draft bill.
          </DialogDescription>
        </DialogHeader>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <FormDatePicker
                        {...field}
                        minDate={orderDateWatch || undefined}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
