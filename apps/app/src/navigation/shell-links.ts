...
export const SHELL_LINKS = [
  ...
  { href: "/sales-revenue" as const, label: "Sales revenue" },
  { href: "/deals" as const, label: "Deals" },
  ...
  { href: "/investor-crm" as const, label: "Investor CRM" },
