...
export default function MarketingCampaignsPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch(`${getAppUrl()}/api/marketing-campaigns/campaigns?page=1&limit=20`, { credentials: "include" });
  ...
  return (
    <View style={styles.root}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.sub}>No campaigns yet.</Text>}
        renderItem={({ item }) => (
