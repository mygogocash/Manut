...
export const PERMISSION_DEFINITIONS: PermissionDef[] = [
  ...
  // ── Sales Revenue CRM (independent parallel of Sales CRM) ──
  {
    ...
    action: "read",
    description: "View own + team-shared Sales Revenue CRM records",
  },
  {
    code: "sales-revenue:team-read",
    module: "sales-revenue",
    action: "team-read",
    description: "View all Sales Revenue CRM records owned by direct reports",
  },
  {
  ...
  },
  {
    ...
    module: "sales-revenue",
    action: "update",
    description: "Update Sales Revenue CRM records (own + team-shared)",
  },
  {
    code: "sales-revenue:delete",
    module: "sales-revenue",
    action: "delete",
    description: "Delete Sales Revenue CRM records (own only by default)",
  },
  {
  ...
  },
  {
    ...
    module: "sales-revenue",
    action: "settings-manage",
    description: "Configure Sales Revenue CRM notification settings",
  },
