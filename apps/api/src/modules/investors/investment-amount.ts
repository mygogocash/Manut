/**
 * Parse free-text investment amounts from the pipeline master sheet.
 * Accepts plain numbers, comma grouping, currency symbols, and K/M suffixes.
 * Non-numeric placeholders (TBD, —, N/A) resolve to 0.
 */
