...
// Phase 2 of the Legal CRM standalone workspace (Option A per-CRM
// schema isolation, 2026-05-26). Validation schemas for the native
// `legal_*` tables introduced in Phase 1. Shape mirrors the IT CRM
...
// the real Legal-checklist xlsx the team imports from (≈1009 rows in
