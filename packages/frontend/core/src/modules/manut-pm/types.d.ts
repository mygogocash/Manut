...
export type MnTaskStatus = 'BACKLOG' | 'TODO' | 'IN_PROGRESS' | 'DONE' | 'CANCELLED';
export type MnTaskPriority = 'NONE' | 'LOW' | 'MEDIUM' | 'HIGH' | 'URGENT';
export declare const MN_TASK_STATUSES: readonly MnTaskStatus[];
export declare const MN_TASK_PRIORITIES: readonly MnTaskPriority[];
...
export declare const MN_GOAL_LEVELS: readonly MnGoalLevel[];
export declare const MN_GOAL_STATUSES: readonly MnGoalStatus[];
...
export type MnDoDPredicateKind = 'DOC_EXISTS' | 'URL_REACHABLE' | 'WORK_PRODUCT_EXISTS' | 'EMBEDDING_SIMILARITY' | 'CUSTOM';
export declare const MN_DOD_PREDICATE_KINDS: readonly MnDoDPredicateKind[];
...
export type MnDoDPredicate = MnDoDDocExistsPredicate | MnDoDUrlReachablePredicate | MnDoDWorkProductExistsPredicate | MnDoDEmbeddingSimilarityPredicate | MnDoDCustomPredicate;
...
export type MnWorkProductKind = 'DOC' | 'FILE' | 'URL' | 'PR' | 'DEPLOYMENT' | 'CSV' | 'SCREENSHOT';
export declare const MN_WORK_PRODUCT_KINDS: readonly MnWorkProductKind[];
...
export declare const MN_INTAKE_STATUSES: readonly MnIntakeStatus[];
/**
...
export type MnTaskPlanStatus = 'DRAFT' | 'UNDER_REVIEW' | 'APPROVED' | 'REJECTED' | 'SUPERSEDED';
export declare const MN_TASK_PLAN_STATUSES: readonly MnTaskPlanStatus[];
