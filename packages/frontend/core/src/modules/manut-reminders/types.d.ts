 ...
 */
export type MnReminderStatus = 'SCHEDULED' | 'PROCESSING' | 'COMPLETED' | 'CANCELLED' | 'FAILED';
 ...
 */
export type MnReminderRuleTrigger = 'DATETIME' | 'OVERDUE_TASK' | 'INACTIVITY' | 'UPCOMING_DEADLINE';
/**
