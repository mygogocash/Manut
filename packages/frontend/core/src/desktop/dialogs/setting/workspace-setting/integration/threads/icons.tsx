...
/**
 * Inline Threads (by Instagram) brand mark — the loose ribbon
 * glyph. Path data simplified and adapted from Simple Icons
 * (https://simpleicons.org, license CC0-1.0). The official mark
 * is black/white; for the analytics Connections panel the
 * colored circular plate uses solid black (#000000) and this
 * glyph paints white on top.
 */
