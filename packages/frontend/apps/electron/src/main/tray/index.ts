      ...
      getConfig: () => [
        {
          label: 'Open Manut',
          click: () => {
            logger.info('User action: Open Manut');
            getMainWindow()
              .then(w => {
                w.show();
              })
              .catch(err => {
                logger.error('Failed to open Manut:', err);
              });
          },
        },
        {
        ...
        'separator',
        {
          label: 'Quit Manut Completely...',
          click: () => {
            logger.info('User action: Quit Manut Completely');
            app.quit();
          },
        },
      ],
