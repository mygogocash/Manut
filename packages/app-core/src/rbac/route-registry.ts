...
export const ROUTE_OVERRIDES: readonly RouteOverride[] = [
  ...
  {
    matches: (pathname) => pathname === "/legal/shared",
    policy: {
      path: "/legal/shared",
      access: "protected",
  ...
  {
    matches: (pathname) => pathname === "/admin/form-config",
    policy: {
  ...
  {
    matches: (pathname) => pathname === "/it-operations/access",
    policy: {
  ...
  {
    matches: (pathname) => pathname === "/it-operations/billing",
    policy: {
  ...
  {
    matches: (pathname) => pathname === "/survey/new",
    policy: {
      path: "/survey/new",
      access: "protected",
  ...
  {
    matches: (pathname) => pathname === "/survey-forms/new",
    policy: {
