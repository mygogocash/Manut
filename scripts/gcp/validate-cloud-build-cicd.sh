...
require_contains "cloudbuild.manut-cloud-run.yaml" "--to-latest"
require_contains "cloudbuild.manut-cloud-run.yaml" "status\\.latestReadyRevisionName"
require_contains "cloudbuild.manut-cloud-run.yaml" "status\\.imageDigest"
